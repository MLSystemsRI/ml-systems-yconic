...
/**
 * Data verification levels for provenance and material records.
 *
 * Level 0: Public record — available from state/EPA databases (free baseline)
 * Level 1: ML Systems verified — provenance-tracked, graded, ML Material ID (paid)
 * Level 2: Double-verified — ML Systems + state regulator cross-confirmed (premium)
 */
...
/**
 * Tier required to access each verification level.
 * Level 0 (public): free
 * Level 1 (ML verified): starter+
 * Level 2 (double-verified): pro+
 */
